 ...
 * from the specification file <tt>ALexico1.jflex</tt>
 */
class miPrimerLexer {
   ...
   */
  miPrimerLexer(java.io.Reader in) {
    this.zzReader = in;
  }
  ...
  public static void main(String argv[]) {
    if (argv.length == 0) {
      System.out.println("Usage : java miPrimerLexer [ --encoding <name> ] <inputfile(s)>");
    }
    else {
      int firstFilePos = 0;
      ...
      for (int i = firstFilePos; i < argv.length; i++) {
        miPrimerLexer scanner = null;
        try {
          java.io.FileInputStream stream = new java.io.FileInputStream(argv[i]);
          java.io.Reader reader = new java.io.InputStreamReader(stream, encodingName);
          scanner = new miPrimerLexer(reader);
